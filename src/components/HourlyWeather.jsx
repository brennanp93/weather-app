...
export default function HourlyWeather({ hourlyData }) {
  ...
  // let timeArray = hourlyData?.hourly?.time.map((t) => t = new Date(t *1000))
...
// console.log(shortTimeData[10], timeArray[10])
...
// console.log(twelveHourForcastTemp, 'tuna')
console.log(twelveHourForcastHours, 'tuna')
  return (
    <>
